<?php
  ...
  $Settings = unserialize(get_post_meta( $PostId, 'Team_M_Settings', true));
	...
	$option_names = array(
		...
		"team_mb_opacity" 	 => $De_Settings['team_mb_opacity'],
...
<Script>
 ...
 //Team Member Wrapper Opacity
   
  jQuery(function() {
    jQuery( "#team_mb_opacity_id" ).slider({
		orientation: "horizontal",
		range: "min",
		max: 100,
		min:1,
		slide: function( event, ui ) {
		jQuery( "#team_mb_opacity" ).val( ui.value );
      }
		});
		
		jQuery( "#team_mb_opacity_id" ).slider("value",<?php echo $team_mb_opacity; ?>);
		jQuery( "#team_mb_opacity" ).val( jQuery( "#team_mb_opacity_id" ).slider( "value") );
    
  });
</script> 
<Script>
function dazzler_update_default(){
	 jQuery.ajax({
		url: location.href,
		type: "POST",
		data : {
...
if(isset($_POST['action123']) == "default_settins_action")
	{
		...
		$Settings_Array2 = serialize( array(
			...
			update_option('Team_M_default_Settings', $Settings_Array2);
}

 ?>
<input type="hidden" id="team_m_setting_save_action" name="team_m_setting_save_action" value="tabs_setting_save_action">

<table class="form-table acc_table">
	<tbody>
		<tr>
			<th scope="row"><label><?php _e('Team Member Name Color',dazzler_team_m_text_domain); ?></label>
			...
			<td>
				...
				<div id="team_mb_name_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Update Your Team Member Name Color Here',dazzler_team_m_text_domain); ?></h2>
						<img src="<?php echo dazzler_team_m_directory_url.'assets/tooltip/img/member-name.png'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr>
			<th scope="row"><label><?php _e('Team Member Designation Color',dazzler_team_m_text_domain); ?></label>
			...
			<td>
				...
				<div id="team_mb_pos_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Update Your Team Member Designation Color Here',dazzler_team_m_text_domain); ?></h2>
						<img src="<?php echo dazzler_team_m_directory_url.'assets/tooltip/img/member-desig.png'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr>
			<th scope="row"><label><?php _e('Team Member Description Color',dazzler_team_m_text_domain); ?></label>
			...
			<td>
				...
				<div id="team_mb_desc_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Update Your Team Member Description Color Here',dazzler_team_m_text_domain); ?></h2>
						<img src="<?php echo dazzler_team_m_directory_url.'assets/tooltip/img/mb-desc-color.png'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr>
			<th scope="row"><label><?php _e('Team Member Social Profile Icon Color',dazzler_team_m_text_domain); ?></label>
			...
			<td>
				...
				<div id="team_mb_social_icon_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Update Your Team Member Social Profile Icon Color Here',dazzler_team_m_text_domain); ?></h2>
						<img src="<?php echo dazzler_team_m_directory_url.'assets/tooltip/img/mb-social-color.png'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr>
			<th scope="row"><label><?php _e('Team Member Social Profile Icon Hover Color',dazzler_team_m_text_domain); ?></label>
			...
			<td>
				...
				<div id="team_mb_social_icon_bg_clr_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('Update Your Team Member Social Profile Icon Background Color Here',dazzler_team_m_text_domain); ?></h2>
						<img src="<?php echo dazzler_team_m_directory_url.'assets/tooltip/img/mb-social-color.png'; ?>">
					</div>
		    	</div>
			</td>
		...
		<tr class="setting_color">
			<th><label><?php _e('Team Member Name Font Size',dazzler_team_m_text_domain); ?></label>
				<a  class="ac_tooltip" href="#help" data-tooltip="#team_mb_social_icon_bg_clr_tp"><i class="fa fa-lightbulb-o"></i></a>
			</th>
			<td>
		...
		<tr class="setting_color">
			<th><label><?php _e('Team Member Designation Font Size',dazzler_team_m_text_domain); ?></label>
				<a  class="ac_tooltip" href="#help" data-tooltip="#team_mb_social_icon_bg_clr_tp"><i class="fa fa-lightbulb-o"></i></a>
			</th>
			<td>
		...
		<tr class="setting_color">
			<th><label><?php _e('Team Member Description Font Size',dazzler_team_m_text_domain); ?></label>
				<a  class="ac_tooltip" href="#help" data-tooltip="#team_mb_social_icon_bg_clr_tp"><i class="fa fa-lightbulb-o"></i></a>
			</th>
			<td>
		...
		<tr >
			<th><label><?php _e('Font Style/Family',dazzler_team_m_text_domain); ?></label>
		...
		<tr>
			<th><label><?php _e('Team Column Display layout ',dazzler_team_m_text_domain); ?> </label>
		...
		<tr>
			<th scope="row"><label><?php _e('Team Member Wrapper background Color',dazzler_team_m_text_domain); ?></label>
			...
			<td>
				...
				<div id="team_mb_wrap_bg_clr_2_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;">
						<h2 style="color:#fff !important;"><?php _e('You can change the team background from here for design 2',dazzler_team_m_text_domain); ?></h2>
						<img src="<?php echo dazzler_team_m_directory_url.'assets/images/team-2.png'; ?>">
					</div>
		    	</div>
			</td>
		</tr>
		...
		<tr class="setting_color">
			<th><label><?php _e('Team Member Wrapper Opacity',dazzler_team_m_text_domain); ?></label>
				<a  class="ac_tooltip" href="#help" data-tooltip="#team_mb_social_icon_bg_clr_tp"><i class="fa fa-lightbulb-o"></i></a>
			</th>
			<td>
				<div id="team_mb_opacity_id" class="size-slider" ></div>
				<input type="text" class="slider-text" id="team_mb_opacity" name="team_mb_opacity"  readonly="readonly">
				<div id="title_size_tp" style="display:none;">
					<div style="color:#fff !important;padding:10px;max-width: 300px;">
						<h2 style="color:#fff !important;">You can update Wrapper Opacity by scroling it .001 to 1.0 it to change size.</h2>
					</div>
		    	</div>
			</td>
		</tr>
