...
if(isset($PostID) && isset($_POST['team_m_save_data_action']) ) {
			...
			if($TotalCount) {
				...
				update_post_meta($PostID, 'dazzler_team_m_data', serialize($All_data));
				update_post_meta($PostID, 'dazzler_team_m_count', $TotalCount);
			} else {
				$TotalCount = -1;
				update_post_meta($PostID, 'dazzler_team_m_count', $TotalCount);
				$All_data = array();
